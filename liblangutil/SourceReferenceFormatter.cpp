...
{
	printExceptionInformation(SourceReferenceExtractor::extract(m_scanner, _exception, _category));
}
...
{
	printExceptionInformation(SourceReferenceExtractor::extract(m_scanner, _error));
}
